...
import 'package:haji_market/features/auth/data/bloc/register_state.dart' as regState;
...
class RegisterSmsCheckModalBottom extends StatefulWidget {
  ...
  const RegisterSmsCheckModalBottom({Key? key, required this.textEditingController, required this.registerDTO})
      : super(key: key);

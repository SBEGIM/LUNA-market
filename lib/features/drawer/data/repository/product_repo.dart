...
bool rating = false;
  ...
  Future<List<ProductModel>> product() async {
    ...
    final response = await http.get(Uri.parse('$baseUrl/shop/search?brand_id=$brandId&shop_id=$shopId&rating=$rating&cat_id=$subCatId&sub_cat_id=$subCatId&search=$search') , headers:{

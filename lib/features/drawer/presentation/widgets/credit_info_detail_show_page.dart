...
import 'package:haji_market/features/drawer/data/bloc/credit_state.dart';
import 'package:haji_market/features/drawer/presentation/widgets/credit_webview.dart';

class CreditInfoDetailShowPage extends StatefulWidget {
  int id;
  String title;

  CreditInfoDetailShowPage({required this.id, required this.title, Key? key})
      : super(key: key);

  @override
  State<CreditInfoDetailShowPage> createState() =>
      _CreditInfoDetailShowPageState();
}
                          ...
                          return GestureDetector(
                            onTap: () {
                              Get.to(() => CreditWebviewPage(
                                  url:
                                      state.creditModel[index].url.toString()));
                            },
                            child: Container(
                              height: 72,
                              ...
                              child: Padding(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    Text(
                                      state.creditModel[index].description
                                          .toString(),
                                      style: const TextStyle(
                                          fontSize: 14,
                                          fontWeight: FontWeight.w500,

...
extension DateTimeExtension on DateTime? {
  ...
  //   } else {
  //     return context.currentLocale.whenByValue(
  //       kk: '''${DateFormat('dd.MM.yyyy', context.currentLocale.languageCode).format(this!)} күні қосылды''',
  //       ru: '''Добавлено ${DateFormat('dd.MM.yyyy', context.currentLocale.languageCode).format(this!)}''',
  //       en: '''Added ${DateFormat('dd.MM.yyyy', context.currentLocale.languageCode).format(this!)}''',
  //     );
  //   }
  // }

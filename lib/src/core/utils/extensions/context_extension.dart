...
import 'package:haji_market/src/core/constant/localization/translations/app_localizations.g.dart';
...
import 'package:haji_market/src/core/utils/screen_util.dart';
import 'package:haji_market/src/feature/initialization/model/dependencies_container.dart';
import 'package:haji_market/src/feature/initialization/widget/dependencies_scope.dart';
import 'package:haji_market/src/feature/settings/widget/settings_scope.dart';
...
extension ContextExtension on BuildContext {
  ...
  /// Выбранный язык
  Locale get currentLocale => SettingsScope.settingsOf(this).locale;

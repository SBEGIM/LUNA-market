...
extension StringExtension on String {
  ...
  /// Vimeo video Id parser
  String? vimeoVideoIdParser() {
    // final regex = RegExp(r'vimeo\.com/(\d+)/([a-zA-Z0-9]+)');
...
extension NullableImageExtension on String? {
  String handleImage() {
    if (this != null && this!.isNotEmpty) {
      ...
      return Constants.common.noImageAvailable;
    }
  }
  ...
  Color toColor({Color fallback = Colors.transparent}) {
    ...
    // Otherwise, convert the integer to a Color

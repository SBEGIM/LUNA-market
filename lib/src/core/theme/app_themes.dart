...
mixin AppTheme {
  static ThemeData get light => ThemeData(
    ...
    inputDecorationTheme: const InputDecorationTheme(
      ...
      hintStyle: TextStyle(fontSize: 16, color: AppColors.greyText, letterSpacing: -1),
      errorStyle: TextStyle(fontSize: 14, color: AppColors.red, letterSpacing: -1),
      ...
      focusedBorder: OutlineInputBorder(
        borderRadius: BorderRadius.all(Radius.circular(16)),
        borderSide: BorderSide(color: AppColors.text, width: 0.5),
      ),
    ),

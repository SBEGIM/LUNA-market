...
class StatisticsBloggerPage extends StatefulWidget {
  ...
  const StatisticsBloggerPage({required this.product, Key? key}) : super(key: key);
...
class _StatisticsBloggerPagetate extends State<StatisticsBloggerPage> {
  List<String> months = ['Январь', 'Февраль', 'Март', 'Апрель', 'Май'];
  List<String> monthsSecond = ['Июнь', 'Июль', 'Август', 'Сентябрь', 'Ноябрь', 'Декабрь'];
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        elevation: 0,
        centerTitle: true,
        title: const Text('Статистика', style: TextStyle(color: Colors.black)),
      ),
      body: BlocConsumer<BloggerProductStatisticsCubit, BloggerProductStatisticsState>(
                        ...
                        child: ListView.builder(
                          ...
                          itemBuilder: (context, index) {
                            return GestureDetector(
                              onTap: () {
                                BlocProvider.of<BloggerProductStatisticsCubit>(
                                  context,
                                ).statistics();
                              ...
                              child: Padding(
                                ...
                                child: chipDate(months[index], index, _selectIndex),
                              ),
                          ...
                          itemBuilder: (context, index) {
                            return GestureDetector(
                              ...
                              child: Padding(
                                ...
                                child: chipDate(monthsSecond[index], index, _SelectSecondIndex),
                                // GestureDetector(
                                //   child: chipDate('Январь', false),
                                // ),
                                // chipDate('Февраль', false),

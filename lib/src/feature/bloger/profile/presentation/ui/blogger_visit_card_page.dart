...
class BloggerVisitCardPage extends StatefulWidget {
  const BloggerVisitCardPage({super.key});

  @override
  State<BloggerVisitCardPage> createState() => _BloggerVisitCardPageState();
}

class _BloggerVisitCardPageState extends State<BloggerVisitCardPage> {
  @override

...
import '../data/repository/chat_blogger_repository.dart';
import 'chat_blogger_state.dart';

class ChatBloggerCubit extends Cubit<ChatBloggerState> {
  List<ChatSellerModel> _chats = [];
  int _page = 1;

  final ChatBloggerRepository chatRepository;

  ChatBloggerCubit({required this.chatRepository}) : super(InitState());

...
class _MessageBloggerState extends State<MessageBlogger> {
  ...
  Future<void> onLoading() async {
    await BlocProvider.of<MessageSellerCubit>(context)
  ...
  @override
  void initState() {
    BlocProvider.of<MessageSellerCubit>(context)
    ...
    channel.stream.listen((event) {
      ...
      if (data['action'] == 'message' || data['action'] == 'file') {
        BlocProvider.of<MessageSellerCubit>(context)
            .newMessage(MessageSellerDTO.fromJson(data));
      }
    });
    super.initState();
  }
                        ...
                        children: [
                          Expanded(
                            child: SmartRefresher(
                              ...
                              // },
                              child:
                                  GroupedListView<MessageSellerDTO, DateTime>(
                                // elements: state.chat,

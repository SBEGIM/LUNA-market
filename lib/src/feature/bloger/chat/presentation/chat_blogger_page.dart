...
import '../cubit/chat_blogger_cubit.dart';
import '../cubit/chat_blogger_state.dart';

@RoutePage()
class ChatBloggerPage extends StatefulWidget {
  const ChatBloggerPage({super.key});

  @override
  State<ChatBloggerPage> createState() => _ChatBloggerPageState();
}
...
class _ChatBloggerPageState extends State<ChatBloggerPage> {
  ...
  Future<void> onRefresh() async {
    await BlocProvider.of<ChatBloggerCubit>(context).chat();
  ...
  Future<void> onLoading() async {
    await BlocProvider.of<ChatBloggerCubit>(context).pagination();
  ...
  @override
  void initState() {
    BlocProvider.of<ChatBloggerCubit>(context).chat();
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        appBar: AppBar(
          ...
          //   ),
          // ),
          title: const Text('Чат', style: AppTextStyles.size18Weight600),
        ),
        body: BlocConsumer<ChatBloggerCubit, ChatBloggerState>(
                      ...
                      children: [
                        Container(
                          ...
                          child: TextField(
                            ...
                            onChanged: ((value) {
                              BlocProvider.of<ChatBloggerCubit>(context)

...
class _ProfileSellerTapeBloggerPageState extends State<ProfileSellerTapeBloggerPage> {
  ...
  Future<void> onLoading() async {
    await BlocProvider.of<TapeCubit>(context).tapePagination(false, false, '', 42);
  ...
  void initState() {
    ...
    BlocProvider.of<ProfileStaticsBloggerCubit>(context).statics(widget.sellerId);
                  ...
                  Row(
                    ...
                    children: [
                      ...
                      Column(
                        ...
                        crossAxisAlignment: CrossAxisAlignment.start,
                        children: [
                          Text(widget.sellerName, style: AppTextStyles.size18Weight600),
                          SizedBox(height: 4),
                          Row(
                            children: [
                              SvgPicture.asset(Assets.icons.sellerIcon.path),
                              SizedBox(width: 5),
                              Text('Официальный партнер', style: AppTextStyles.size13Weight400),
                            ],
                          ),
                          SizedBox(height: 4),
                          Text(
                  ...
                  Row(
                    ...
                    children: [
                      Expanded(
                        child: InkWell(
                          onTap: () {
                            BlocProvider.of<SubsCubit>(context).subShop(widget.sellerId);
                            setState(() {
                              inSub = !inSub;
                            });
                          ...
                          child: Container(
                            margin: EdgeInsets.only(left: 16, right: 0, top: 15, bottom: 5),
                            height: 36,
                            decoration: BoxDecoration(
                              color: inSub != true
                      ...
                      Expanded(
                        child: InkWell(
                          ...
                          child: Container(
                            margin: EdgeInsets.only(left: 8, right: 0, top: 15, bottom: 5),
                            height: 36,
                            decoration: BoxDecoration(
                      ...
                      Expanded(
                        child: InkWell(
                          ...
                          child: Container(
                            margin: EdgeInsets.only(left: 8, right: 16, top: 15, bottom: 5),
                            height: 36,
                            decoration: BoxDecoration(
                              color: AppColors.kGray2,
                              borderRadius: BorderRadius.circular(12),

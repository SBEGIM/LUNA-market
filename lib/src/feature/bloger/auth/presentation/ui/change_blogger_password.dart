...
class ChangePasswordBloggerPage extends StatefulWidget {
  ...
  const ChangePasswordBloggerPage({super.key, required this.textEditingController});
      ...
      body: BlocConsumer<SmsBloggerCubit, SmsBloggerState>(
        listener: (context, state) {
          if (state is ResetSuccessState) {
            context.router.popUntil((route) => route.settings.name == BlogAuthRegisterRoute.name);
          }
        },

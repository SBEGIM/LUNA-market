...
import 'package:haji_market/src/feature/bloger/auth/data/bloc/sms_blogger_state.dart';
...
@RoutePage()
class ChangePasswordBloggerPage extends StatefulWidget {
  final String textEditingController;
  const ChangePasswordBloggerPage({
    Key? key,
    required this.textEditingController,
  }) : super(key: key);

  @override
  State<ChangePasswordBloggerPage> createState() =>
      _ChangePasswordBloggerPageState();
}

class _ChangePasswordBloggerPageState extends State<ChangePasswordBloggerPage> {

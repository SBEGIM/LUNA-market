...
import 'package:haji_market/src/feature/shop/auth/data/bloc/sms_admin_state.dart';
...
class LoginForgotAdminPasswordModalBottom extends StatefulWidget {
  ...
  @override
  State<LoginForgotAdminPasswordModalBottom> createState() =>
      _LoginForgotAdminPasswordModalBottom();
}

class _LoginForgotAdminPasswordModalBottom
    extends State<LoginForgotAdminPasswordModalBottom> {
  late Timer _timer;
  int _start = 60;
  ...
  Widget build(BuildContext context) {
    return BlocConsumer<SmsAdminCubit, SmsAdminState>(

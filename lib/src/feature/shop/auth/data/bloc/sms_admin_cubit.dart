...
class SmsAdminCubit extends Cubit<SmsAdminState> {
  final RegisterAdminRepository registerRepository;

  SmsAdminCubit({required this.registerRepository}) : super(InitState());

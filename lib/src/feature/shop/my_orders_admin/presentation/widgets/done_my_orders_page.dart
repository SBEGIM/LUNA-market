...
import '../../../../bloger/my_orders_admin/presentation/widgets/detail_my_orders_page.dart';
                              ...
                              Navigator.push(
                                ...
                                MaterialPageRoute(
                                    builder: (context) => DetailMyOrdersPage(
                                        basket:
                                            state.basketEndOrderModel[index])),
                              );
                            },
                            child: Container(
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  SizedBox(
                                    height: state.basketEndOrderModel[index]
                                            .product!.length *
                                        20,
                                    child: ListView.builder(
                                        shrinkWrap: true,

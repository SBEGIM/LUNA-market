...
import 'package:haji_market/src/feature/shop/my_products_admin/presentation/widgets/brands_admin_page.dart';
import 'package:haji_market/src/feature/shop/my_products_admin/presentation/widgets/colors_admin_page.dart';
        ...
        if (state is LoadedState) {
          return Padding(
            ...
            child: ListView(
              ...
              children: [
                BlocListener<lastArticul.LastArticulCubit,
                    lastArticul.LastArticulState>(
                  listener: (context, stateArticul) {
                    if (stateArticul is lastArticul.LoadedState) {
                      articulController.text =
                          getFormattedArticle(stateArticul.articul.toString());
                    }
                  },

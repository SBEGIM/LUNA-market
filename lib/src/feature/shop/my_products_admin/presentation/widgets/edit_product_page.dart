...
import 'package:haji_market/src/feature/shop/my_products_admin/data/DTO/optom_price_dto.dart';
import 'package:haji_market/src/feature/shop/my_products_admin/data/DTO/size_count_dto.dart';
import 'package:haji_market/src/feature/shop/my_products_admin/data/bloc/characteristics_cubit.dart';
import 'package:haji_market/src/feature/shop/my_products_admin/data/bloc/color_cubit.dart';
import 'package:haji_market/src/feature/shop/my_products_admin/data/bloc/delete_image_cubit.dart'
    as deleteImageCubit;
import 'package:haji_market/src/feature/shop/my_products_admin/data/bloc/product_admin_state.dart';
...
class _EditProductPageState extends State<EditProductPage> {
  ...
  void _charactisticsArray() async {
    characteristics =
        await BlocProvider.of<CharacteristicsCubit>(context).characteristic();
          ...
          child: ListView(
            ...
            children: [
              ...
              Padding(
                ...
                child: BlocListener<deleteImageCubit.DeleteImageCubit,
                    deleteImageCubit.DeleteImageState>(
                  listener: (context, state) {
                    if (state is deleteImageCubit.LoadedState) {
                      _networkImage.remove(state.deletingImagePath);
                      BlocProvider.of<deleteImageCubit.DeleteImageCubit>(
                              context)
                          .toInit();
                      setState(() {});
                    }

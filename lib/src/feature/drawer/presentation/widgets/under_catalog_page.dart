        ...
        title: Container(
          ...
          child: TextField(
            ...
            decoration: const InputDecoration(
              ...
              hintText: 'Поиск',
              hintStyle: TextStyle(color: AppColors.kGray300, fontSize: 16),
              ...
              children: [
                ...
                InkWell(
                  onTap: () {
                    ...
                    context.router.push(ProductsRoute(cats: widget.cats));
                    // Navigator.push(
                    //   context,
                    //   MaterialPageRoute(
                    //       builder: (context) =>
                    ...
                    return Column(
                      children: [
                        InkWell(
                          ...
                          child: UnderCatalogListTile(title: state.cats[index].name.toString()),
                        ),
                        const Divider(color: AppColors.kGray300),
                      ],
                    );
...
class UnderCatalogListTile extends StatelessWidget {
  final String title;
  const UnderCatalogListTile({required this.title, Key? key}) : super(key: key);

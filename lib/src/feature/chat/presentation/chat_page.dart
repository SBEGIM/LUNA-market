                      ...
                      children: [
                        Container(
                          ...
                          child: TextField(
                            ...
                            onChanged: (value) {
                              context.read<ChatCubit>().searchChats(value); // implement in cubit
                            },
                            ...
                            children: [
                              CircleAvatar(
                                backgroundImage: item.avatar != null
                                    ? NetworkImage('https://lunamarket.ru/storage/${item.avatar}')

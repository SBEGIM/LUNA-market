...
class SuccessSellerProductStorePage extends StatefulWidget {
  ...
  @override
  State<SuccessSellerProductStorePage> createState() =>
      _SuccessSellerProductStorePageState();
}

class _SuccessSellerProductStorePageState
    extends State<SuccessSellerProductStorePage> {
  @override
            ...
            onTap: () {
              ...
              context.read<AppBloc>().add(
                    const AppEvent.chageState(
                        state: AppState.inAppAdminState(index: 1)),
                  );

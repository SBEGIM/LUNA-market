...
class _ColorsSellerPageState extends State<ColorsSellerPage> {
  int _selectedIndex = -1;
  CatsModel? _cat;

  @override
  void initState() {
    BlocProvider.of<ColorSellerCubit>(context).brands();
    super.initState();
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        elevation: 0,
        centerTitle: true,
        title: const Text('Цвета', style: AppTextStyles.appBarTextStyle),
        leading: Padding(
      ...
      body: ListView(
        ...
        children: [
          Container(
            color: Colors.white,
            child: BlocConsumer<ColorSellerCubit, ColorSellerState>(

...
class SubCatsSellerPage extends StatefulWidget {
  CatsModel? cats;
  SubCatsSellerPage({required this.cats, Key? key}) : super(key: key);

  @override
  State<SubCatsSellerPage> createState() => _SubCatsSellerPageState();
}

class _SubCatsSellerPageState extends State<SubCatsSellerPage> {

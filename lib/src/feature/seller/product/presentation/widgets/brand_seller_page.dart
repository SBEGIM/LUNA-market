...
class BrandSellerPage extends StatefulWidget {
  const BrandSellerPage({Key? key}) : super(key: key);

  @override
  State<BrandSellerPage> createState() => _BrandsellerPageState();
}

class _BrandsellerPageState extends State<BrandSellerPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        elevation: 0,
        centerTitle: true,
        title: const Text('Бренды', style: AppTextStyles.appBarTextStyle),
        leading: Padding(

...
class CategorySellerPage extends StatefulWidget {
  const CategorySellerPage({Key? key}) : super(key: key);

  @override
  State<CategorySellerPage> createState() => _CategorySellerPageState();
}

class _CategorySellerPageState extends State<CategorySellerPage> {

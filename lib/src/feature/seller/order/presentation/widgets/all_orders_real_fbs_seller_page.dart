...
class AllOrdersRealFbsSellerPage extends StatefulWidget {
  String fulfillment;
  AllOrdersRealFbsSellerPage({required this.fulfillment, Key? key})
      : super(key: key);

  @override
  State<AllOrdersRealFbsSellerPage> createState() =>
      _AllOrdersRealFbsSellerPageState();
}

class _AllOrdersRealFbsSellerPageState
    extends State<AllOrdersRealFbsSellerPage> {
                            ...
                            child: Container(
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  SizedBox(
                                    height: state.basketOrderRealFbsModel[index]
                                            .product!.length *
                                        20,
                                    child: ListView.builder(
                                        shrinkWrap: true,

      ...
      appBar: AppBar(
        ...
        title: AnimatedSwitcher(
          ...
          child: _searchOpen
                  ...
                  child: SizedBox(
                    ...
                    child: TextField(
                      ...
                      onChanged: (value) {
                        ...
                        context.read<productCubit.ProductCubit>().products(filters);
                      },
                      // onSubmitted: (q) {},
                      ...
                      decoration: InputDecoration(
                        ...
                        focusedBorder: OutlineInputBorder(
                          borderRadius: BorderRadius.circular(12),
                          borderSide: BorderSide(color: AppColors.mainPurpleColor, width: 1),
                        ),
              ...
              : Text('', style: AppTextStyles.size18Weight600),
        ),
        ...
        actions: _searchOpen
            ? [
                TextButton(
                  ...
                  child: Text(
                    'Отменить',
                    style: TextStyle(color: AppColors.mainPurpleColor, fontWeight: FontWeight.w600),
                  ),
                ),
              ]
            : [

...
class PopularCatsHomepage extends StatefulWidget {
  const PopularCatsHomepage({Key? key}) : super(key: key);

  @override
  _PopularCatsHomePageState createState() => _PopularCatsHomePageState();
}

class _PopularCatsHomePageState extends State<PopularCatsHomepage> {
  @override
  Widget build(BuildContext context) {
    return BlocBuilder<SubCatsCubit, SubCatsState>(builder: (context, state) {

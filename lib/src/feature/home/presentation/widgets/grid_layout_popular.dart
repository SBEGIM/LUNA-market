...
//   GridLayoutPopular({this.title, this.icon, this.image, this.credit, this.bonus});
// }

// class GridOptionsPopular extends StatelessWidget {
//   final GridLayoutPopular? layout;

//   const GridOptionsPopular({super.key, this.layout});
...
//                 image: NetworkImage("https://lunamarket.ru/storage/${layout!.icon ?? ''}"),
//                 fit: BoxFit.cover,
//               ),

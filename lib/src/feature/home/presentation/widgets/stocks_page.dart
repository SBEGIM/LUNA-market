...
// import 'package:haji_market/src/feature/home/presentation/widgets/bonus_page.dart';
...
//         //   )
//         // ],
//         title: const Text('Акции', style: AppTextStyles.appBarTextStylea),
//       ),
//       body: ListView(
//         shrinkWrap: true,
//         children: [
...
//   const StocksCardWidget({Key? key}) : super(key: key);
...
//           MaterialPageRoute(
//             builder: (context) =>
//                 const BonusPage(name: '', bonus: 0, date: '', image: '', description: '', url: ''),
//           ),
//         );
//       },
//       child: Center(
...
//               Stack(
//                 children: [
//                   Image.asset('assets/images/stocks.png'),
//                   const Padding(

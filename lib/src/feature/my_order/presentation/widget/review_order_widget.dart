...
class ReviewOrderWidgetPage extends StatefulWidget {
  ...
  const ReviewOrderWidgetPage({required this.basketOrder, required this.index, super.key});
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        centerTitle: true,
        elevation: 0,
        title: const Text('Оставить отзыв', style: AppTextStyles.appBarTextStyle),
      ),
      body: Column(
        children: [
            ...
            child: Row(
              ...
              children: [
                if (widget.basketOrder.product != null &&
                    ...
                    (widget.basketOrder.product?[widget.index].path?.isNotEmpty ?? false))
            ...
            child: Column(
              ...
              children: [
                Row(
                  mainAxisAlignment: MainAxisAlignment.spaceBetween,
                  children: [
                    const Text('Оцените товар', style: AppTextStyles.size16Weight600),
                    RatingBar.builder(
                      initialRating: 0,
                      minRating: 1,
                      itemSize: 28,
                      ...
                      itemBuilder: (context, _) =>
                          Image.asset(Assets.icons.defaultStarIcon.path, color: Color(0xffFFBE00)),
                                ...
                                children: [
                                  ...
                                  Center(
                                    child: GestureDetector(
                                      onTap: () => setState(() => _image.removeAt(index)),
                                      child: Container(
                                        width: 28,
                                        height: 28,
                                        alignment: Alignment.center,
      ...
      bottomSheet: BlocConsumer<ReviewCubit, ReviewState>(

...
const CdekOfficeOldModel({this.code , this.status , this.postalCode , this.name , this.countryCode , this.countryCodeIso , this.countryName , this.regionCode , this.regionName , this.cityCode , this.city , this.workTime , this.address , this.fullAddress , this.phone , this.note , this.coordX , this.coordY , this.type , this.ownerCode , this.isDressingRoom , this.haveCashless , this.haveCash , this.allowedCod , this.takeOnly , this.isHandout , this.isReception , this.fulfillment , this.nearestStation , this.metroStation , this.email , this.addressComment , this.weightLimit , this.workTimeYList , this.phoneDetailList });
CdekOfficeOldModel copyWith({String? code, String? status, String? postalCode, String? name, String? countryCode, String? countryCodeIso, String? countryName, String? regionCode, String? regionName, String? cityCode, String? city, String? workTime, String? address, String? fullAddress, String? phone, String? note, String? coordX, String? coordY, String? type, String? ownerCode, bool? isDressingRoom, bool? haveCashless, bool? haveCash, bool? allowedCod, bool? takeOnly, bool? isHandout, bool? isReception, bool? fulfillment, String? nearestStation, String? metroStation, String? email, String? addressComment, WeightLimit? weightLimit, List<WorkTimeYList>? workTimeYList, List<PhoneDetailList>? phoneDetailList}){
...
'phoneDetailList': phoneDetailList?.map<Map<String,dynamic>>((data)=> data.toJson()).toList()
    };
}
...
weightLimit:json['weightLimit'] == null ? null : WeightLimit.fromJson(json['weightLimit']  as Map<String,Object?>),
workTimeYList:json['workTimeYList'] == null ? null : (json['workTimeYList'] as List).map<WorkTimeYList>((data)=> WorkTimeYList.fromJson(data  as Map<String,Object?>)).toList(),
phoneDetailList:json['phoneDetailList'] == null ? null : (json['phoneDetailList'] as List).map<PhoneDetailList>((data)=> PhoneDetailList.fromJson(data  as Map<String,Object?>)).toList()
    );
}
...
@override
bool operator ==(Object other){
    return other is PhoneDetailList && 
        other.runtimeType == runtimeType &&
        other.number == number;
}

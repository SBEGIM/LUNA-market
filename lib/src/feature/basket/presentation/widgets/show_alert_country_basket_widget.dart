...
Future<dynamic> showAlertCountryBasketWidget(
  ...
  return showCupertinoModalPopup(
    ...
    builder: (BuildContext context) => StatefulBuilder(
      builder: (contextBtmSheet, setState) {
        return CustomCupertinoActionSheet(
                  ...
                  if (state is LoadedState) {
                    return Container(
                      constraints: BoxConstraints(
                        maxHeight: (MediaQuery.of(contextBtmSheet).size.height) * 0.85,
                      ),
          ...
          cancelButton: GestureDetector(
            onTap: () {
              ...
              Future.wait([
                BlocProvider.of<cityCubit.CityCubit>(context).citiesCdek(countryCode ?? 'KZ'),
              ]);

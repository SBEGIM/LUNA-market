                    ...
                    ? Row(
                        ...
                        children: [
                          Text(
                            ...
                            style: AppTextStyles.size18Weight700.copyWith(color: Color(0xff1A1C1F)),
                          ),
                          Text(
                      ...
                      Container(
                        ...
                        child: Row(
                          children: [
                            GestureDetector(
                              onTap: () async {
                                await BlocProvider.of<BasketCubit>(context).basketMinus(
                            ...
                            GestureDetector(
                              ...
                              child: const Icon(Icons.add, color: AppColors.mainPurpleColor),
                            ),
                          ],
                        ),
                      ),

...
import 'package:haji_market/bloger/auth/presentation/ui/login_admin_page.dart';
...
class ChangePasswordBloggerPage extends StatefulWidget {
  ...
  @override
  State<ChangePasswordBloggerPage> createState() => _ChangePasswordBloggerPageState();
}
...
class _ChangePasswordBloggerPageState extends State<ChangePasswordBloggerPage> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: BlocConsumer<SmsBloggerCubit, SmsBloggerState>(listener: (context, state) {

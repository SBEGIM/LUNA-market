...
import '../../../../../bloger/profile_admin/presentation/data/model/profile_statics_blogger_model.dart';
...
class ProfileStaticsBloggerCubit extends Cubit<ProfileStaticsBloggerState> {
  ...
  Future<void> statics(int? bloggerId) async {
    try {
      emit(LoadingState());
      final ProfileStaticsBloggerModel data = await profileStaticsBloggerRepository.statics(bloggerId);

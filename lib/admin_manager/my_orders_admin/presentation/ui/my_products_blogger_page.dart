...
import '../../../../bloger/my_orders_admin/data/bloc/blogger_video_products_state.dart';
import '../../../../bloger/my_orders_admin/presentation/widgets/show_alert_statictics_widget.dart';
                    ...
                    child: Container(
                      ...
                      child: GridView.builder(
                          ...
                          itemBuilder: (BuildContext ctx, index) {
                            return Stack(
                              children: [
                                BannerWatcehRecentlyBloggerPage(product: state.productModel[index]),
                                Container(
                                  decoration: BoxDecoration(borderRadius: BorderRadius.circular(10)),
                                ),
                                InkWell(
                                  onTap: () {
                                    showAlertBloggerWidget(context, state.productModel[index]);
                                  },
                                  child: Container(
                                    height: 28,
                                    width: 28,
                                    margin: const EdgeInsets.only(top: 8.0, right: 8.0, left: 135),

...
import 'package:haji_market/admin/auth/presentation/ui/login_forget_password_modal_bottom.dart';
import 'package:haji_market/bloger/auth/presentation/ui/login_forget_password_modal_bottom.dart';
...
class ForgotPasswordAdminPage extends StatefulWidget {
  const ForgotPasswordAdminPage({Key? key}) : super(key: key);

  @override
  State<ForgotPasswordAdminPage> createState() => _ForgotPasswordAdminPageState();
}
      ...
      body: BlocConsumer<SmsAdminCubit, SmsAdminState>(listener: (context, state) {
        if (state is LoadedState) {
          showModalBottomSheet(
              ...
              context: context,
              builder: (context) {
                return LoginForgotAdminPasswordModalBottom(

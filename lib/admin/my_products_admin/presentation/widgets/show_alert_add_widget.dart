...
import '../../../../features/basket/presentation/widgets/payment_webview_widget.dart';
...
class ShowAdTypesAlert extends StatefulWidget {
  final AdminProductsModel product;
  const ShowAdTypesAlert({super.key, required this.product});

  @override
  State<ShowAdTypesAlert> createState() => _ShowAdTypesAlertState();
}

class _ShowAdTypesAlertState extends State<ShowAdTypesAlert> {
  int adPrice = -1;
      ...
      actions: <Widget>[
                        ...
                        child: Row(
                          ...
                          children: [
                            ...
                            GestureDetector(
                              ...
                              child: Icon(
                                adPrice == e.price ? Icons.check_box : Icons.check_box_outline_blank,
                                color: AppColors.kPrimaryColor,
                                size: 24.0,
                              ),
                            ),
        ...
        CupertinoActionSheetAction(
          onPressed: () async {
            ...
            final data = await BlocProvider.of<ProductAdminCubit>(context).ad(widget.product.id!, adPrice);
            load = false;
            setState(
              () {},
            );
          ...
          child: load == true
              ...
              : Text(
                  ...
                  style: const TextStyle(color: AppColors.kPrimaryColor, fontWeight: FontWeight.w700, fontSize: 20),
                ),
        ),
      ],
      cancelButton: CupertinoActionSheetAction(
